...
- **Status:** 🟡 all three halves now ship (text F-068 🟢 · audio F-210 🟢 · images F-211 🟢 dormant); umbrella remaining = deliver them as ONE progressively-complete package + shared library status · **Priority:** P2 · **Category:** API (BACKEND, DATABASE, UI) · epic
