...
def full_dir(tmp_path: pathlib.Path) -> pathlib.Path:
    """A tmp directory containing EVERY production migration file present in
    this worktree (may or may not include 056, depending on merge order —
    057 only depends on 055 and earlier)."""
